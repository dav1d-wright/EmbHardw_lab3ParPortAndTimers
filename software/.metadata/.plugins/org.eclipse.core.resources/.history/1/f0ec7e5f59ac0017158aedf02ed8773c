...
__attribute__((section(".exceptions")))static void handle_timerIRQ(void* context, alt_u32 id);
...
int main(void)
{
	...
	perf_print_formatted_report(PERFORMANCE_COUNTER_0_BASE, alt_get_cpu_freq(), 1, "ISR");
	return 0;
}
