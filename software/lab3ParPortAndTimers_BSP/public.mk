...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../systemFile.sopcinfo
...
# Design Name 
# setting SOPC_NAME is systemFile
SOPC_NAME := systemFile
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20030c0
SOPC_SYSID_FLAG += --sidp=0x20030c0
ELF_PATCH_FLAG  += --sidp 0x20030c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1507626423
SOPC_SYSID_FLAG += --timestamp=1507626423
ELF_PATCH_FLAG  += --timestamp 1507626423
